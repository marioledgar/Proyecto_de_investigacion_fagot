...
\section{Introducción} \label{sec:intro} \subfile{partes/intro/intro}

\section{Marco teórico} \label{sec:marco} \subfile{partes/marco_teorico/marco_teorico}

\appendix
\section{Demostraciones} \label{sec:demostraciones} \subfile{partes/apendices/demostraciones}

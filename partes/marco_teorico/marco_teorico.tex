...
\begin{figure}[ht!]
    \centering
    \subcaptionbox{Muestreo.}{\includegraphics[width = 7cm]{figuras/DFT/sampling.png}}
    \subcaptionbox{Periodificación.}{\includegraphics[width = 7cm]{figuras/DFT/periodica.png}}
...
Esto se debe a que lo que vibra en estos instrumentos, en vez de ser unidimensional como una cuerda, es bidimensional (en caso de la membrana de un tambor) o tridimensional (en el caso de una campana o un xilófono) \cite{instruments}.

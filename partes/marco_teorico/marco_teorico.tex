...
Se dice que el fagot es un instrumento de tubo cerrado, pues el tubo está en contacto con el exterior solo por uno de los extremos.
El hecho de que un instrumento sea abierto (como la flauta travesera) o cerrado es de gran importancia como se explica más adelante, ya que afecta en gran medida al registro del instrumento.
...
Estos impulsos se reflejan al final del tubo (o en el primer agujero abierto).
\todo{¿Por qué rebotan?}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote1.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote2.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote3.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote4.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote5.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote6.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote7.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote8.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote9.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote10.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote11.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote12.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote13.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote14.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote15.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote16.jpeg}
    \includegraphics[width=0.7\textwidth]{figuras/vibracion_rebote/vibracion_rebote17.jpeg}
    \caption{Las ondas sonoras se reflejan al llegar al final del tubo. Fuente: \cite{fluteacoustics}.}
    \label{fig:vibracion_rebote}
\end{figure}

Además, como se puede ver en la figura \ref{fig:vibracion_rebote}, si uno de los extremos está abierto, la vibración se invierte en este extremo:
si ha llegado como una zona de baja presión, volverá como una de alta presión.
Si el extremo está abierto, no se invierte.
\todo{Lo de la onda estacionaria.}

Sin embargo, no todas las notas se producen de la misma manera: mediante el ``sobresoplado'' (del inglés ``overblowing'').
Esta es una técnica que consiste en la modificación de la embocadura, la velocidad del aire y otras características de la manera de tocar por parte del intérprete.
Con estos cambios se fuerza el que suene un armónico más alto.
De esta manera, se pueden conseguir notas más agudas que la asociada con la menor longitud del tubo posible \cite{koppreedsHarmonics}.
